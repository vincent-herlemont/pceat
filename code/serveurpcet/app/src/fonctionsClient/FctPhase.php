...
class FctPhase {
	...
	public static function verifModifPhase($tabParametres){
		...
		if($tabParametres['date_debut_prevue'] != $phaseConcernee->date_debut_prevue){
			...
			$tabParamChanges['descriptionModification'] = $tabParamChanges['descriptionModification']."Ancienne date de début prévue : ".$phaseConcernee->date_debut_prevue ." ";
		}
		else {
		...
		if($tabParametres['date_fin_prevue'] != $phaseConcernee->date_fin_prevue){
			...
			$tabParamChanges['descriptionModification'] = $tabParamChanges['descriptionModification']."Ancienne date de fin prévue : ".$phaseConcernee->date_fin_prevue ." ";
		}
		else {
		...
		if($tabParametres['date_debut_reelle'] != $phaseConcernee->date_debut_reelle){
			...
			$tabParamChanges['descriptionModification'] = $tabParamChanges['descriptionModification']."Ancienne date de debut réelle : ".$phaseConcernee->date_debut_reelle ." ";
		}
		else {
		...
		if($tabParametres['date_fin_reelle'] != $phaseConcernee->date_fin_reelle){
			...
			$tabParamChanges['descriptionModification'] = $tabParamChanges['descriptionModification']."Ancienne date de fin réelle : ".$phaseConcernee->date_fin_reelle ." ";
		}
		else {
		...
		if((isset($tabParametres['ponderation_phase'])) && $tabParametres['ponderation_phase'] != $phaseConcernee->ponderation_phase){
			...
			$tabParamChanges['descriptionModification'] = $tabParamChanges['descriptionModification']."Ancienne pondération : ".$phaseConcernee->ponderation_phase ." ";
		}
		else {
